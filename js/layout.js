...
// ... existing code from your template


// YOUR PARALLAX CODE STARTS HERE
(function () {
    const hero = document.querySelector("#vanta-bg.hero-parallax");
    ...
    function updateParallax() {
      ...
      const progress = Math.min(
        Math.max((windowHeight - rect.top) / (windowHeight + sectionHeight), 0),
        1
      );
  
      const offsetY = -progress * maxShift * speed;
      hero.style.backgroundPositionY = offsetY + "px";
    }
